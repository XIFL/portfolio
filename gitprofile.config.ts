...
const CONFIG = {
  github: {
    username: 'XIFL', // Your GitHub org/user name. (This is the only required config)
  },
  /**
    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ['XIFL/portfolio', 'XIFL/ExampleBPProject', 'XIFL/Example-Project'], 
  ...
  seo: {
    title: 'Portfolio of Timothy Chan',
    description: '',
    imageURL: '',
  },
  social: {
  ...
  experiences: [
    {
      company: 'DAQA',
      position: 'Video Games QA Tester',
      from: 'May 2022',
      to: 'Present',
      companyLink: '',
    },
